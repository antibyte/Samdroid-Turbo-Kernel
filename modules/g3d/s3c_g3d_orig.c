...
#include "/home/spica/i5700.2/kernel/arch/arm/plat-s3c/dma-pl080.c"
...
static int s3c_g3d_ioctl(struct inode *inode, struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	case START_DMA_BLOCK:
		...
		//dma_cache_maint((void *) dma_info.dst, dma_info.len, DMA_FROM_DEVICE);
...
*/
static char init_error[] __initdata = KERN_ERR "Intialization of S3C G3D driver failed\n";
...
/*	s3c_g3d_device = platform_device_alloc("s3c-g3d", -1);
	...
	printk("g3d was registered successfully!");
	return 0;
}
