...
#define POLLING_INTERVAL	30000     // QBANIN mod, old: 10000 ,original: 2000
#ifdef __TEST_MODE_INTERFACE__
#define POLLING_INTERVAL_TEST	30000      // QBANIN mod, old: 5000 ,original: 1000
#endif /* __TEST_MODE_INTERFACE__ */
...
//	if (total_time_msec > total_time) // commented by QBANIN
//		return 1;
//	else
		return 0;
}
