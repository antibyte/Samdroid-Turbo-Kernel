			  ...
			  unsigned long devaddr)
{
	...
	case S3C_DMA_MEM2MEM:
		...
		tmp = S3C_DMACONFIG_TCMASK | S3C_DMACONFIG_FLOWCTRL_MEM2MEM | S3C_DMACONFIG_CHANNEL_ENABLE; // | S3C_DMACONFIG_LOCK;
		...
		chan->control_flags |= (S3C_DMACONTROL_SRC_INC | S3C_DMACONTROL_DEST_AXI_PERI
				...
				| S3C_DMACONTROL_DEST_WIDTH_WORD | S3C_DMACONTROL_SRC_WIDTH_WORD;
		//chan->control_flags = hwcfg;
