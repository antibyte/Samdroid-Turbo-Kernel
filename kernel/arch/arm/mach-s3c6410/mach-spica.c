...
{     
	...
	writel(0xffb6, S3C_VA_SYS + 0x128); //88ac - 88bd - ff49 - ffb6 - 7742

	/* AXI QoS */
	writel(0x7, reg + 0x460);   					
	/* (8 - MFC ch.) */
	writel(0x7ff7, reg + 0x464);      				

	/* AXI QoS */
	writel(0x7, reg + 0x440);   					
	/* (G3D)0x88ac */
	writel(0x089c, reg + 0x444);

	/* AXI QoS */
	writel(0x7, reg + 0x420);   					
	/* (6 - DMA) */
	writel(0x098c, reg + 0x424);

	/* AXI QoS */
	writel(0x7, reg + 0x400);   					
	/* (CPU) 098c*/
	writel(0x88ac, reg + 0x404);
